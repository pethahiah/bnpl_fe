  ...
  const data = [
    {
      ...
      link: `${useGetBaseLink()}/directdebit/directdebit_dashboard`,
    ...
    },
    {
      ...
      description: 'Easily make payments according to your schedules.',
      link: `${useGetBaseLink()}/credit/credit_dashboard`,
