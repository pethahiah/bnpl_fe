...
const MerchantHomePage = () => {
  ...
  const data = [
    {
      title: 'BNPL Stores',
      label: 'BNPL',
      description: 'Easily manage your stores and bnpl accross them.',
      link: `${useGetBaseLink()}/stores`,
    ...
    {
      title: 'BNPL Bank Account',
      description: 'Easily Manage bank accounts accross multiple stores.',
      link: `${useGetBaseLink()}/bank-accounts`,
      label: 'PayThru Credit',
      linkText: 'Get Started',
      color: '#0898A01A',
      img: '',
      textColor: '',
  ...
  return (
    <div className="w-full flex flex-col justify-start items-center py-10 min-h-screen">
      <div className="mb-6">
        <p className="text-4xl">Welcome to PayThru</p>
        <p className="text-lg my-2">What would you like to do on PayThru today?</p>
      </div>
      <div className="w-[90%] xl:w-[70%] my-6 grid grid-cols-1 sm:grid-cols-2  justify-center gap-6">
        {
          data.map((itm) => (
